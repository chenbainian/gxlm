			...
			<div class="banner">
                      <!--轮播 -->
						<div class="am-slider am-slider-default scoll" data-am-flexslider id="demo-slider-0">
							<ul class="am-slides">
								<?php if(is_array($broad_list) || $broad_list instanceof \think\Collection): $i = 0; $__LIST__ = $broad_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
								<li style="background: <?php echo (isset($vo['bg_color']) && ($vo['bg_color'] !== '')?$vo['bg_color']:''); ?>;"><img style="width: 1100px;height: 430px" src="<?php echo (isset($vo['img_src']) && ($vo['img_src'] !== '')?$vo['img_src']:''); ?>" /></li>
					...
					<div class="am-g am-g-fixed flood method3 ">
						<ul class="am-thumbnails ">
							<?php if(is_array($goods) || $goods instanceof \think\Collection): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo3): $mod = ($i % 2 );++$i;if($vo3['big_cate_id'] == $vo['id']): ?>
									<li>
										<div class="list ">
											<a href="<?php echo url('goods/goods_detail',['goods_id'=>$vo3['id']]); ?>">
