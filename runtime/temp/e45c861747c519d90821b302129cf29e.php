<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:33:"./tpl/admin/goods\goods_list.html";i:1513423353;s:26:"./tpl/admin/base\base.html";i:1488437847;s:32:"./tpl/admin/base\common_css.html";i:1488437847;s:31:"./tpl/admin/base\common_js.html";i:1488437847;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="mt-20">
    <table class="table table-border table-bordered table-bg table-hover table-sort">
        ...
        <tr class="text-c">
            ...
            <td><?php echo (isset($vo['unit']) && ($vo['unit'] !== '')?$vo['unit']:''); ?></td>
            <td><?php echo (isset($vo['true_sales_num']) && ($vo['true_sales_num'] !== '')?$vo['true_sales_num']:0); ?></td>
            <td><?php echo (isset($vo['show_sales_num']) && ($vo['show_sales_num'] !== '')?$vo['show_sales_num']:0); ?></td>
            <td class="td-manage">
