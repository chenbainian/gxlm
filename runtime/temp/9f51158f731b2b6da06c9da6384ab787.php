<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:27:"./tpl/admin/broad\form.html";i:1513419317;s:26:"./tpl/admin/base\base.html";i:1488437847;s:32:"./tpl/admin/base\common_css.html";i:1488437847;s:31:"./tpl/admin/base\common_js.html";i:1488437847;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<form class="form form-horizontal" id="form-article-add">
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-5">
            <input type="text" class="input-text" placeholder="背景颜色" name="bg_color" value="<?php echo (isset($info['bg_color']) && ($info['bg_color'] !== '')?$info['bg_color']:''); ?>">
        </div>
    </div>
