<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:29:"../tpl/api/account/index.html";i:1512477690;s:30:"../tpl/api/base/common_js.html";i:1488437846;}*/ ?>
<!DOCTYPE html>
<html>
	...
	<head lang="en">
		...
		<link rel="stylesheet" type="text/css" href="/static/api/AmazeUI-2.4.2/assets/css/amazeui.css" />
		<link href="/static/api/css/dlstyle.css" rel="stylesheet" type="text/css">
	</head>

	<body>

		<div class="login-boxtitle">
			<a href="home.html"><img alt="logo" src="/static/api/images/logobig.png" /></a>
		</div>

		<div class="login-banner">
			<div class="login-main">
				<div class="login-banner-bg"><span></span><img src="/static/api/images/big.jpg" /></div>
				<div class="login-box">
