<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:34:"./tpl/admin/cate\see_son_cate.html";i:1511264732;s:26:"./tpl/admin/base\base.html";i:1488437847;s:32:"./tpl/admin/base\common_css.html";i:1488437847;s:31:"./tpl/admin/base\common_js.html";i:1488437847;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <table class="table table-border table-bordered table-bg table-hover table-sort">
        ...
        <tr class="text-c">
            ...
            <td>
                ...
                <?php if($vo['type'] == 1): ?>
                <input class="btn btn-danger radius see_sons" data-id="<?php echo (isset($vo['id']) && ($vo['id'] !== '')?$vo['id']:0); ?>" type="button" value="查看子分类">
                <?php endif; ?>
            </td>
        </tr>
...
<input type="hidden" id="forbid_admin" value="<?php echo url('admin/account/forbid'); ?>">
<input type="hidden" id="unforbid_admin" value="<?php echo url('admin/account/unforbid'); ?>">
