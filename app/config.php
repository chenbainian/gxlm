...
return [
    ...
    // 禁止访问模块
    'deny_module_list' => json_decode(__default_forbid_module__,true),
    // 默认控制器名
    'default_controller' => __default_controller__,
    // 默认操作名
    ...
    'view_replace_str' => [
        ...
        '__hui__' => '/public/static/hui/base',
        '__hui_admin__' => '/public/static/hui/admin',
    ],
    // 默认跳转页面对应的模板文件
    ...
    //全局统一加密KEY
    'union_sign_key' => 'PqTgfCM00i73brLBh9f7',
    ...
    'regular_rule' => [
        ...
        'username' => '/^[^0-9^\_]\w{5,19}$/',
        'password' => '/^.{6,30}$/',
        'ip' => '/^[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}$/'
    ],

    //默认头像
    'empty_head_img' => '/public/static/public/img/no_pic.jpg',
    ...
    //更新结束时间
    'update_time_end' => '2016-12-3 6:0:0'
];
